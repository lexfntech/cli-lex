  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError('Invalid credentials or unauthorized admin access');
      }
    } catch (err) {
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-6 sm:p-8 animate-slideIn">
        ...
        <div className="mt-4 sm:mt-6 text-center">
          <p className="text-sm sm:text-base text-gray-600">
            ...
            <Link to="/signup/admin" className="text-orange-500 hover:text-orange-600 font-medium touch-manipulation">
              Sign up here
            </Link>
          </p>
        </div>
