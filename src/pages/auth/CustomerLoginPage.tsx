  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError('Invalid credentials or unauthorized customer access');
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 animate-fadeIn">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-6 sm:p-8 animate-slideIn">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Customer Login</h2>
          <p className="text-sm sm:text-base text-gray-600 mt-2">Sign in to your customer account</p>
        </div>
        ...
        <div className="mt-4 sm:mt-6 text-center">
          <p className="text-sm sm:text-base text-gray-600">
            ...
            <Link to="/signup/customer" className="text-orange-500 hover:text-orange-600 font-medium touch-manipulation">
              Sign up here
            </Link>
          </p>
        </div>
